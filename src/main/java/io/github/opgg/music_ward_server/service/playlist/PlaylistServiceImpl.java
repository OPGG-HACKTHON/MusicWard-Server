...
public class PlaylistServiceImpl implements PlaylistService {
    ...
    public NonPlaylistsResponse getNonPlaylists() {
        ...
        Token googleRefreshToken = tokenRepository.findById(userId)
                .orElseThrow(EmptyRefreshTokenException::new);

        GoogleAccessTokenResponse accessToken = userService.getAccessToken(googleRefreshToken.getGoogleRefreshToken());
